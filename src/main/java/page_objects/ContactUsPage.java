...
public class ContactUsPage {
    ...
    public void populateNameField(String name) {
        ...
        Browser.wait.until(ExpectedConditions.visibilityOfElementLocated(nameField)).sendKeys(name);
    }
    ...
    public void populateEmailField(String email) {
        ...
        Browser.wait.until(ExpectedConditions.visibilityOfElementLocated(emailField)).sendKeys(email);
    }
    ...
    public void populateMessageField(String message) {
        ...
        Browser.wait.until(ExpectedConditions.visibilityOfElementLocated(messageField)).sendKeys(message);
    }
